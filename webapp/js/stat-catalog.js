...
(function (root, factory) {
  ...
  const CATALOG = [
    ...
    { id: "carryDistance", label: "Carry Distance", path: "BallData.CarryDistance", unit: " yds", decimals: 0 },
    { id: "ballSpeed", label: "Ball Speed", path: "BallData.Speed", unit: " mph", decimals: 1 },
  ...
  const DEFAULT_STAT_IDS = ["clubPath", "faceToTarget", "smashFactor"];
  const MAX_STATS = 3;
